...
void main() {
  testWidgets('login: rechaza datos inválidos y autentica los válidos', (
    ...
    await pumpUntil(
      ...
      reason: 'que el backend rechace las credenciales falsas',
    );
    expect(find.byType(LoginPage), findsOneWidget);
    expect(hasSession, isFalse);
    ...
    await pumpUntil(
      ...
      () => hasSession,
      reason:
          'que se abra sesión con EVENTIX_TEST_EMAIL/PASSWORD; la cuenta debe '
          'existir y estar verificada en Supabase',
    );
