/// Resultado del flujo de Stripe Checkout embebido en el WebView.
///
/// Reemplaza los strings mágicos `'success'`/`'cancel'` del return_url por
/// un tipo cerrado que los call-sites pueden hacer switch exhaustivo.
enum CheckoutResult {
  success,
  cancel;
