...
void main() {
  ...
  /// Todas las pantallas del flujo montadas juntas: es un flujo, y probarlo
  /// pantalla por pantalla no diría si encajan.
  ...
  group('confirmación', () {
    testWidgets('cierra la sesión temporal antes de volver al login', (
      ...
      // El reset deja una sesión abierta: volver al login sin cerrarla dejaría
      // al usuario autenticado sin saberlo.
