...
void main() {
  ...
  testWidgets('pinta tantas casillas como dígitos trae el código', (
    ...
    // El bug que motivó esta prueba: la constante existía pero no se le pasaba
    // al campo, que se quedaba en 6 casillas mientras el correo traía 8, y el
    // código no se podía ingresar.
